...
<% String email = session.getAttribute("email").toString(); %>
    ...
    <a href="home.jsp" class="active">Home <i class="fa fa-institution"></i></a>
    ...
    <form class="form-search" action="searchHome.jsp">
              <input class="form-control border-0 input-box bg-100" name="search" type="search" placeholder="Search Food" aria-label="Search">
              <button class="btn btn-white shadow-warning text-warning" type="submit">Search</button>
          </form>
    </div>
</div>
</div>